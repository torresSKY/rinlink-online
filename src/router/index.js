    ...
    routes: [
      ...
      // },
      {
        ...
        children: [
          ...
          {path: 'policeMessage',name: 'route.showala',component: () =>import('@/views/wechart/policeMessage'),hidden: true,meta: { keep: 'policeMessage'},radius:true,roles:[0,1,88,99],},
          {path: 'statistics',name: 'route.tongji',component: () =>import('@/views/wechart/Alastatistics'),hidden: true,meta: { keep: 'policeMessage'},radius:true,roles:[0,1,88,99],},
        ]
      },
      {
        path: '/UserManagement',
