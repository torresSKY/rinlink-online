    ...
    <el-row :gutter="20" class="item_row_item">
      ...
      <el-col :span="8">
        <el-card>
          ...
          <el-row>
                <el-col :span="17">
                    <div id="myChart2" :style="{ height: '26vh', margin: '10px auto' }"></div>
                </el-col>
                <el-col :span="7">
      ...
      <el-col :span="8">
        <el-card>
          ...
          <el-row>
                <el-col :span="17">
                    <div id="myChart3" :style="{ height: '26vh', margin: '10px auto' }"></div>
                </el-col>
                <el-col :span="7">
    ...
    <el-row :gutter="20">
      <el-col :span="8">
        <el-card>
          ...
          <el-row>
                <el-col :span="17">
                    <div id="myChart4" :style="{ height: '26vh', margin: '10px auto' }"></div>
                </el-col>
                <el-col :span="7">
                        ...
                        <div class="track_info_btn">
                            <el-row>
                                <el-col :span="8" offset="8">
                                    <el-button size="small" class="track_info_btn_bt">查看轨迹</el-button>
                                </el-col>
                            </el-row>
                            <el-row>
                                <el-col :span="8" offset="8">
                                    <el-button size="small" class="track_info_btn_bt">追踪</el-button>
                                </el-col>
                            </el-row>
                        </div>
                    </div>
