<template>
    <div class="app" :style="{height:height +'px',overflow:'hidden' }">
        ...
        <!-- 关联设备 -->
        <relevanceDevice :fenceId="relevance_fenceId" :relevanceFlag="relevance_flag" @closeRelevance="evt_close_relevance"></relevanceDevice>
...
import relevanceDevice from './fence/relevanceDevice.vue'
export default {
    name: 'electric',
    mixins:[mixin],
    components:{
    ...
    methods: {
        ...
        evt_eventListener:function(){
            ...
            _this.drawingManager.addEventListener('overlaycomplete',function(e){
                ...
                if(_this.pen_type_value == '1'){
                    ...
                    _this.point_arr = [];//置空上次添加多边形围栏的点的数组
        ...
        evt_show_relevance:function(item){
            ...
            this.relevance_flag = true;
        },
        evt_close_relevance:function(){
            this.relevance_flag = false;
