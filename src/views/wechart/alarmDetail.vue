        ...
        <el-row :gutter="22">
            <el-col :span='24'>
                ...
                <el-row style="margin-top:10px">
                    <el-col :span='4'>
                      <el-button size="mini" >{{$t('table.chuli')}}</el-button>
                    </el-col> 
                </el-row>    
                <el-row style="margin-top:10px">
  ...
  data() {
    return {
      ...
      data: [{
        ...
        {label: this.$t('table.alatype'), prop: 'partner_contacts'},
        {label: this.$t('table.alartime'), prop: 'partner_contacts'},
        {label: this.$t('table.alarmAddress'), prop: 'partner_contacts'},
        {label: this.$t('table.handler'), prop: 'partner_contacts'},
        {label: this.$t('table.proStatus'), prop: 'partner_contacts'},
        {label: this.$t('table.proTime'), prop: 'partner_contacts'},
        {label: this.$t('table.process'), prop: 'partner_contacts'},     
      ],
      value1:[]
