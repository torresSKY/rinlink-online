...
const getEqulistnew = (data) => {  // 获取所有设备
    return axios.get('http://aep-location.beijing.rinlink.com/device', data)
}
...
const getEquList = (data) => (  //查询单个设备
    axios.get(`http://aep-location.beijing.rinlink.com/device/check`, data)
)

const getEquListtwo = (data) => (   //模糊查询设备
    axios.get(`http://aep-location.beijing.rinlink.com/device/getDevInfoByLike`, data)
)
...
const equAdd = (data) =>(
    axios.post('http://aep-location.beijing.rinlink.com/device',data)
)

const equEdit = (data) => (
   axios.put('http://aep-location.beijing.rinlink.com/device',data)
)

const equDelete=(id)=>(
    axios.delete('http://aep-location.beijing.rinlink.com/device/' + id)
)
...
const getUsersListPagination = (data) => (  // 获取用户
    axios.get('http://aep-location.beijing.rinlink.com/user',data)
)

const userAdd = (data) =>(
    axios.post('http://aep-location.beijing.rinlink.com/user',data)
)
...
const userEdit = (data) => (
    axios.put('http://aep-location.beijing.rinlink.com/user/child',data)
)
...
const getUserEqu = (id) => (
    axios.get('http://aep-location.beijing.rinlink.com/device/total/' + id)
)
...
const getLocation = (imei) => (
    axios.get(`http://aep-location.beijing.rinlink.com/devicedata/location/${imei}`)
)

const getGroupList = (obj) => ( 
    axios.get(`http://aep-location.beijing.rinlink.com/devicedata/location`,{
        params:{
            ...obj
        }
    })
...
const getGroupListPagination = (data) => ( // 获取所有分组
    axios.get('http://aep-location.beijing.rinlink.com/devicegroup',data)
)

const groupAdd = (data) =>( // 添加分组
    axios.post('http://aep-location.beijing.rinlink.com/devicegroup',data)
)

const groupEdit = (data) => ( // 编辑分组
    axios.put('http://aep-location.beijing.rinlink.com/devicegroup',data)
)

const groupDelete=(data)=>( // 删除分组
    axios.delete('http://aep-location.beijing.rinlink.com/devicegroup',data)
)
...
const getMessageListPagination = (data) => ( //获取报警数据
    axios.get(`http://aep-location.beijing.rinlink.com/devicedata/warning`,data)
)

const getMessageChuli = (val) => ( //报警数据处理
    axios.get(`http://aep-location.beijing.rinlink.com/devicedata/warningProcess?alarmId=`+ val +`&isProcess=1`)
)

const getMessageCount = (data) => ( //获取报警统计
    axios.get(`http://aep-location.beijing.rinlink.com/devicedata/warningCount`,data)
)

const getMessageDown = (data) => ( //报警统计柱状图
    axios.get(`http://aep-location.beijing.rinlink.com/devicedata/exportWarningExcelImpage`,data)
)

const sendorder = (data) => {
   return axios.post('http://aep-location.beijing.rinlink.com/devicedata/order', data)
}

const historyOrder = (data) => {
    return axios.get('http://aep-location.beijing.rinlink.com/devicedata/order', data)
}
...
const addmoreequ = (data) => { //批量添加设备
    return axios.post('http://aep-location.beijing.rinlink.com/device/uploadDevExcel',data)
}

const getowern = (data) => { //批量添加设备
    return axios.get('http://aep-location.beijing.rinlink.com/device/getUserIdList/' + data)
}

const downalalist = (data) => { //批量添加设备
    return axios.get('http://aep-location.beijing.rinlink.com/devicedata/exportAlarm' , data)
}
const getall = () => { //首页所有设备
    return axios.get('http://aep-location.beijing.rinlink.com/home')
}
